...
extension SystemDataUsage {
    ...
    public static var upload: UInt64 {
        return SystemDataUsage.getDataUsage().wifiSent + SystemDataUsage.getDataUsage().wirelessWanDataSent
    }
    
    public static var download: UInt64 {
        return SystemDataUsage.getDataUsage().wifiReceived + SystemDataUsage.getDataUsage().wirelessWanDataReceived
    }
